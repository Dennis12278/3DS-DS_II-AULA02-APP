...
const baseService = require("./segitrvices/base.service");
const linksService = require("./services/links.service");
const linksController = require("./routes/controllers/links.controller");
...
function startApp({ counterRepository, linksRepository }) {
    ...
    const linkRouterController = linksController(links, "/", 30);
